...
| **app_settings** | ✅ | ✅ admin-all / authenticated-select-public | ✅ 17 claves (payment, booking, materials, features, policy, **whatsapp.***) | ✅ WhatsApp leído desde Cloud (fallback local) | 🟡 WhatsApp integrado; pendiente refactor de `services/paymentConfig.ts` |
